package com.example.grocerygo.login_form;
...
import com.example.grocerygo.MainActivity;
...
public class Register extends AppCompatActivity implements View.OnClickListener{
    ...
    Button mRegisterbtn;
    TextView mLoginPageBack,txtregister;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginPageBack = (TextView)findViewById(R.id.txtLogin);
